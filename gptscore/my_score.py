...
class Scorer:
    ...
    def __init__(self, args=None):
        ...
        # Evaluate dataset ..
        # new_data = {idx: self.data[idx] for idx in range(len(self.data))}
        # self.data = new_data
    ...
    def score(self, metrics):
        ...
        for metric_name in metrics:
            if metric_name in [
                ...
                eval_asps = ["Coverage", "Consistency", "Relevance"]
                metric2checkpoint = {
                ...
                for e_asp in eval_asps:
                    ...
                    print('demo: ', demo)
                    print('asp_df: ', asp_df)
                    refhyp_templates = ["XXXXX 用另一段话表达就是，  YYYYY", " 用另一段话表达就是，  "]
                ...
                for e_asp in eval_asps:
                    ...
                    print('demo: ', demo)
                    print('asp_df: ', asp_df)
                    refhyp_templates = ["XXXXX 用另一段话表达就是， YYYYY", ]
                    template = refhyp_templates[0]  # template
                    refhyp_demos, hypref_demos = self.demo_convert(demo, template)
                ...
                print('demo: ', demo)
                print('asp_df: ', asp_df)
                refhyp_templates = ["XXXXX 用另一段话表达就是，  \nYYYYY",]
                template = refhyp_templates[0]  # template
                refhyp_demos, hypref_demos = self.demo_convert(demo, template)
...
def main():
    ...
    data_dir = "./datas/meta_datas/my/"
    demon_dir = "./datas/demos/my/"
    out_dir = './analysis/my/'+out_dir1
